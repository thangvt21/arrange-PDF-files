...
# PATH_OUTPUT_DROPBOX = "E:/Dropbox/THANG 11/" + FOLDER_NAME + "/"
PATH_OUTPUT_DROPBOX = "E:/FlashPOD Dropbox/FlashPOD/THANG 11/" + FOLDER_NAME + "/"
...
DATA = [
    ["3XL", "2XL", "XL", "L", "M", "S"],
    ["3XL LARGE", "2XL LARGE", "XL LARGE", "LARGE", "MEDIUM", "SMALL"],
    [
        "3XL LARGE FB",
        "2XL LARGE FB",
        "XL LARGE FB",
    ...
    for file in os.listdir():
        ...
        if splitted[3] == "S":
            if len(splitted) == 9:
                if splitted[6] != "1":
                    shutil.move(file, PATH_NEW_ORDER_DROPBOX + "SET")
                elif splitted[4] == "BLACK":
                    shutil.move(file, PATH_BLACK_DROPBOX + "SMALL")
                elif splitted[4] == "WHITE":
                    shutil.move(file, PATH_WHITE_DROPBOX + "SMALL")
